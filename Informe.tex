...
En la presente tesina se caracterizan láminas delgadas de la aleación $NiTiZr$. La aleación base, $NiTi$, en composiciones cercanas a la equiatómica, es una material con memoria de forma. Al agregársele $Zr$ en detrimento de $Ti$ se espera que sus propiedades cambien para conseguir un material con memoria
de forma de alta temperatura.


Para lograr la caracterización, se realizaron dos deposiciones de láminas delgadas usando la técnica de deposición por magnetrón sputtering. Una de estas deposiciones fue rica en $Ni$ (porc)mientras que la otra pobre en $Ni$ (porc). Las láminas obtenidas por este proceso presentaron un estado amorfo a temperatura ambiente.


Primeramente, se estudió el proceso de cristalización utilizando los modelos teóricos de Kissinger y de Augis-Bennet. A través del primer método, el valor obtenido para la energía de activación fue de $(420 \pm 30) kJ$ mientras que por el segundo, de $(410 \pm 30) kJ$.


Luego, se avanzó en el estudio de los efectos de los tratamientos de cristalización a distintas temperaturas sobre la microestructura de las láminas y su relación con las temperaturas de transformación. Mediantes los estudios de difracción por rayos X y imágenes via SEM, se analizaron las distintas fases presentes y su tamaño de grano. Finalmente, mediante las técnicas de resistividad por método de cuatro puntos y calorimetría diferencial de barrido, se analizaron las temperaturas asociadas a la transformación martensítica. 

Se determinó que en todos los casos, la transformación martensítica sucedía completamente por debajo de la temperatura ambiente, con excepción de la muestra rica en $Ni$ tratada a 700$^\circ C$. 
\end{abstract}
