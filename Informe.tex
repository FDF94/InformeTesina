...
Con el objetivo de conocer las fases presentes se realizaron los estudios de difracción por rayos X y se tomaron imágenes mediante TEM. En la Tabla \ref{PhasesNiPoor} se resumen las distintas fases halladas y los tamaños de grano vistos para cada una de las muestras sometidas a un tratamiento térmico.
