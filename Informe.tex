...
Se lograron determinar las temperaturas de la transformación martensítica y de su inversa para la muestra rica en $Ni$ tratada térmicamente a 700$^\circ C$ ($M_s=56^\circ C$, $M_f=0^\circ C$, $A_s=18^\circ C$, $A_f=85^\circ C$). En las restantes muestras se determinó que la totalidad de la transformación, si sucede, lo hace en temperaturas debajo de la ambiente, ya que contienen una presencia mayoritaria de fase B2 a temperatura ambiente. Así mismo, se corroboró la presencia de la fase H, fase que endurece la fase matriz, en las muestras ricas en $Ni$ tratadas térmicamente a 700$^\circ C$ y 800$^\circ C$.
\end{abstract}
