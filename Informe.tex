...
Las diversas velocidades de calentamiento fueron 5, 10, 20, 30 y 50 $^{\circ C }/min$ en láminas obtenidas en la segunda deposición. Las mediciones obtenidas se muestran en la figura \todo{poner la figura}
...
\begin{figure}[H]
\centering
\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 24a.jpg}} 
\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 24b.jpg}} \\
\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 24c.jpg}} 
\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 24d.jpg}} 
...
\begin{figure}[H]
\centering
\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 25a.jpg}} 
\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 25b.jpg}} \\
\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 25c.jpg}} 
\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 25d.jpg}} 
...
\textit{Para analizar las curvas, primero fueron divididas entre enfriamiento y calentamiento, para luego restarseles la línea base. Para realizar las restas, tanto la línea base como las mediciones fueron unidas por splines lineales, permitiendo interpolar y que ambas curvas tengan exactamente los mismos puntos en el eje x. No se considera que esto haya introducido error, ya que la medición no presenta ruido y los puntos originales son muy cercanos entre sí.}\todo{Mover a un apéndice}
...
\begin{figure}[H]
\centering
\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 27a.jpg}} 
\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 27b.jpg}} \\
\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 27c.jpg}}
\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 27d.jpg}}
...
\begin{figure}[H]
\centering
\subfloat[Muestra a $500 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 28a.jpg}} 
\subfloat[Muestra a $600 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 28b.jpg}} \\
\subfloat[Muestra a $700 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 28c.jpg}}
\subfloat[Muestra a $800 ^\circ C$]{\includegraphics[scale=0.6]{img/TEM/Fig 28d.jpg}}
...
\newpage
\section{Apéndice}
\towrite{Ver como hacer que esto aparezca al final de todo}
