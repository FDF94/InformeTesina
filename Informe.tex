...
\begin{equation*}
	- \Delta G_{q}^{A \leftrightarrow M} \geq W_{elast} + W_{fric}
\end{equation*} 
ya que al aumentar el trabajo elástico, es necesario un mayor sobreenfriamiento para inducir la transformación.
\todo{Acá ver bien lo de Energía de Gibbs}
...
En cuanto a las otras muestras, en temperaturas entre $0 ^\circ C$ y $-100 ^\circ C$ se observan cambios en la resistividad asociables a la transformación martensítica y a su inversa, pero es difícil por la cantidad de ruido presente determinar con precisión las temperaturas de inicio y final para ambas transformacion
